...
* `embedded.kafka.dockerImage` `(default is set to 'confluentinc/cp-schema-registry:7.9.6')`
...
* `embedded.kafka.schema-registry.dockerImage` `(default : confluentinc/cp-schema-registry:7.9.6)`
