...
* `embedded.zookeeper.reuseContainer` `(boolean, true|false, default is 'false')`
* `embedded.zookeeper.waitTimeoutInSeconds` `(default is 60 seconds)`
* `embedded.zookeeper.dockerImage` `(default : confluentinc/cp-zookeeper:5.5.1)`
...
* `embedded.kafka.reuseContainer` `(boolean, true|false, default is 'false')`
...
* `embedded.kafka.schema-registry.reuseContainer` `(boolean, true|false, default is 'false')`
