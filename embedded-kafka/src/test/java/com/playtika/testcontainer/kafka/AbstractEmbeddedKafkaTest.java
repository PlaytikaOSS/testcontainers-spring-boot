...
import com.playtika.testcontainer.kafka.camel.samples.SampleProductionRouteContext;
...
@SpringBootTest(
        properties = {
                ...
                "embedded.kafka.withEnvProperties.KAFKA_AUTO_CREATE_TOPICS_ENABLE=false"
        },
