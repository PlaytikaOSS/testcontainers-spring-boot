...
##### Consumes (via files-to-copy.properties)
* embedded.postgresql.filestocopy[index].inputResource `(File path either from classpath with 'classpath:' prefix or system path)`
* embedded.postgresql.filestocopy[index].containerPath `(File path of container where the file will be copied)`
##### Produces
* inputResource
* containerPath
